...
print("Customer purchased \""+str(item_name)+"\", costing $"+str(item_original_price)+" "+str(item_original_currency)+".")
print("The price is $"+str(round(usd_exchange_rates['CAD']*item_original_price, 2)) +" in "+currency_details['CAD']['name']+" ,"+currency_details['CAD']['symbol']+".")